...
cmd="$JAVA7BIN -Xmx7G -Djava.io.tmpdir=$TmpDir -jar $GATKJAR -T ApplyRecalibration -R $REF -input $VcfFil.vcf -mode SNP --ts_filter_level 99.0 -recalFile $VcfFil.recalibrate_SNP.recal -tranchesFile $VcfFil.recalibrate_SNP.tranches -o $VcfFil.recal_snps.vcf
    -nt $NumCores"
echo $cmd >> $LogFil
$cmd
echo "" >> $LogFil
