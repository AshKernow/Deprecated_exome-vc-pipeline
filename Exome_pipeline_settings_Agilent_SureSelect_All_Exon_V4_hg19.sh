...
export EXOMSCR="/ifs/home/c2b2/af_lab/ads2202/scratch/Exome_Seq/scripts/Exome_pipeline_scripts" # Directory containing pipeline shell scripts
...
export TARGET="$EXOMRES/SureSelect_Human_All_Exon_V4_UTRs_Covered.orderandbuffered_hg19.bed" # Exome capture targets
...
export NumCores=6
#Alignment scripts
export mapExmAlloc="mem=4G,time=6::" # ExmAln.2.Align_BWA.sh - 2 or 4 cores 
export ConvS2BAlloc="mem=16G,time=8::" # ExmAln.3.ConvSamtoBam.sh
...
export GenBQSRAlloc="mem=2G,time=6::" # ExmAln.7.RecalibrateBaseQuality.sh - 8 or 12 cores (depending on cluster) 
export AppBQSRAlloc="mem=2G,time=3::" # ExmAln.7.RecalibrateBaseQuality.sh - 8 or 12 cores (depending on cluster) 
export AnaCovAlloc="mem=2G,time=6::" # ExmAln.7a.ExmAln.7a.AnalyseCovariation.sh- 8 or 12 cores (depending on cluster)
...
export AnnVCFAlloc="mem=4G,time=24::" # ExmVC.6.AnnotateVCF.sh
